...
public class ShellMenuItemTests
{
    ...
    {
        var item = new LumiFiles.Models.ShellMenuItem();
    ...
    {
        var item = new LumiFiles.Models.ShellMenuItem { Children = null };
    ...
    {
        var item = new LumiFiles.Models.ShellMenuItem { Children = new() };
    ...
    public void HasSubmenu_WhenHasChildren_ReturnsTrue()
    {
        var item = new LumiFiles.Models.ShellMenuItem
        {
            Children = new()
            {
                new LumiFiles.Models.ShellMenuItem { Text = "Child" }
            }
        };
