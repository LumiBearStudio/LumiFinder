...
public class FolderItemTests
{
    ...
    {
        var folder = new LumiFiles.Models.FolderItem();
    ...
    {
        var folder = new LumiFiles.Models.FolderItem { Name = "Documents", Path = @"C:\Documents" };

        LumiFiles.Models.IFileSystemItem item = folder;
    ...
    {
        var folder = new LumiFiles.Models.FolderItem { Name = "Root", Path = @"C:\" };

        folder.Files.Add(new LumiFiles.Models.FileItem { Name = "readme.txt" });
        folder.SubFolders.Add(new LumiFiles.Models.FolderItem { Name = "Sub" });
