...
public class ConnectionInfoTests
{
    ...
    [TestMethod]
    [DataRow(LumiFiles.Models.RemoteProtocol.SFTP, 22)]
    [DataRow(LumiFiles.Models.RemoteProtocol.FTP, 21)]
    [DataRow(LumiFiles.Models.RemoteProtocol.FTPS, 990)]
    [DataRow(LumiFiles.Models.RemoteProtocol.SMB, 445)]
    public void GetDefaultPort_ReturnsCorrectPort(LumiFiles.Models.RemoteProtocol protocol, int expected)
    {
        Assert.AreEqual(expected, LumiFiles.Models.ConnectionInfo.GetDefaultPort(protocol));
    }
    ...
    public void GetDefaultPort_UnknownProtocol_Returns22()
    {
        ...
        var unknown = (LumiFiles.Models.RemoteProtocol)999;
        Assert.AreEqual(22, LumiFiles.Models.ConnectionInfo.GetDefaultPort(unknown));
    }
    ...
    public void DefaultValues_AreCorrect()
    {
        ...
        Assert.AreEqual(LumiFiles.Models.RemoteProtocol.SFTP, conn.Protocol);
        Assert.AreEqual(string.Empty, conn.Host);
        Assert.AreEqual(22, conn.Port);
        Assert.AreEqual(string.Empty, conn.Username);
        Assert.AreEqual(LumiFiles.Models.AuthMethod.Password, conn.AuthMethod);
    ...
    {
        var a = new LumiFiles.Models.ConnectionInfo();
        var b = new LumiFiles.Models.ConnectionInfo();
    ...
    {
        var values = Enum.GetValues<LumiFiles.Models.RemoteProtocol>();
        Assert.AreEqual(4, values.Length);
        CollectionAssert.Contains(values, LumiFiles.Models.RemoteProtocol.SFTP);
        CollectionAssert.Contains(values, LumiFiles.Models.RemoteProtocol.FTP);
        CollectionAssert.Contains(values, LumiFiles.Models.RemoteProtocol.FTPS);
        CollectionAssert.Contains(values, LumiFiles.Models.RemoteProtocol.SMB);
    }

    [TestMethod]
    public void AuthMethod_HasExpectedValues()
    {
        var values = Enum.GetValues<LumiFiles.Models.AuthMethod>();
        Assert.AreEqual(2, values.Length);
        CollectionAssert.Contains(values, LumiFiles.Models.AuthMethod.Password);
        CollectionAssert.Contains(values, LumiFiles.Models.AuthMethod.SshKey);
    }
}
