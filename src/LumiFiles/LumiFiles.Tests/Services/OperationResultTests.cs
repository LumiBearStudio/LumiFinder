...
public class OperationResultTests
{
    ...
    {
        var result = LumiFiles.Services.FileOperations.OperationResult.CreateSuccess();
    ...
    {
        var result = LumiFiles.Services.FileOperations.OperationResult.CreateSuccess(@"D:\temp\output.log");
    ...
    {
        var result = LumiFiles.Services.FileOperations.OperationResult.CreateFailure("Access denied");
    ...
    {
        var result = LumiFiles.Services.FileOperations.OperationResult.CreateFailure("");
    ...
    {
        var result = new LumiFiles.Services.FileOperations.OperationResult();
    ...
    {
        var result = LumiFiles.Services.FileOperations.OperationResult.CreateSuccess(@"C:\a.txt");
