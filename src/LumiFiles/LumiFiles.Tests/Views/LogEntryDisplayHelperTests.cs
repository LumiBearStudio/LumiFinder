...
namespace LumiFiles.Tests.Views;
...
public class LogEntryDisplayHelperTests
{
    ...
    {
        var entries = new List<LumiFiles.Models.ActionLogEntry>
        {
            new() { Success = true },
            new() { Success = true }
        };
    ...
    {
        Assert.AreEqual(0, LogEntryDisplayHelper.CountErrors(new List<LumiFiles.Models.ActionLogEntry>()));
    }
}
