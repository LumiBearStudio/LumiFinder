...
namespace LumiFiles.UITests.Tests;
...
///
/// Usage:
///   1. Launch Lumi Files (F5)
///   2. Run: dotnet test src/LumiFiles/LumiFiles.UITests/LumiFiles.UITests.csproj -p:Platform=x64 --filter "ScreenshotReviewTests"
///   3. Screenshots saved to: LumiFiles.UITests/TestResults/Screenshots/{lang}/
///   4. Run analyzer: dotnet run --project src/LumiFiles/LumiFiles.ScreenshotAnalyzer [screenshots-dir]
/// </summary>
[TestClass]
