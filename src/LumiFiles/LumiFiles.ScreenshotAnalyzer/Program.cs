...
///   dotnet run --project src/LumiFiles/LumiFiles.ScreenshotAnalyzer [screenshots-dir]
///
/// Default screenshots-dir: src/LumiFiles/LumiFiles.UITests/TestResults/Screenshots/
/// </summary>
...
async Task<string> AnalyzeScreenshot(HttpClient client, string imagePath, string langCode)
{
    ...
    var prompt = $"""
        You are a UI/UX quality reviewer for a Windows desktop file explorer app (Lumi Files).
...
string FindScreenshotDir()
{
    var candidates = new[]
    {
        Path.Combine("src", "LumiFiles", "LumiFiles.UITests", "TestResults", "Screenshots"),
        Path.Combine("..", "LumiFiles.UITests", "TestResults", "Screenshots"),
        Path.Combine("LumiFiles.UITests", "TestResults", "Screenshots"),
    };
