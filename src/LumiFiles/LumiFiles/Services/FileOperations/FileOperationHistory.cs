namespace LumiFiles.Services.FileOperations;
...
public class FileOperationHistory
{
    ...
    public async Task<OperationResult> UndoAsync(CancellationToken cancellationToken = default)
    {
        if (!CanUndo)
        {
            return OperationResult.CreateFailure(LumiFiles.Services.LocalizationService.L("Toast_NothingToUndo"));
        }
    ...
    public async Task<OperationResult> RedoAsync(CancellationToken cancellationToken = default)
    {
        if (!CanRedo)
        {
            return OperationResult.CreateFailure(LumiFiles.Services.LocalizationService.L("Toast_NothingToRedo"));
        }
