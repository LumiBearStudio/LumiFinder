namespace LumiFiles.Services
{
    public partial class LocalizationService
    {
        internal static readonly (string key, string en, string ko, string ja, string zhHans, string zhHant, string de, string es, string fr, string ptBR)[] Entries =
        {
            ...
            ("Settings_ContextMenuDesc", "Add 'Open in Lumi Files' to Windows right-click menu", "윈도우 우클릭 메뉴에 'Open in Lumi Files' 추가", "Windowsの右クリックメニューに「Open in Lumi Files」を追加", "将\u201C在 Lumi Files 中打开\u201D添加到 Windows 右键菜单", "將「在 Lumi Files 中開啟」新增到 Windows 右鍵功能表", "'In Lumi Files öffnen' zum Windows-Kontextmenü hinzufügen", "Agregar 'Abrir en Lumi Files' al menú contextual de Windows", "Ajouter « Ouvrir dans Lumi Files » au menu contextuel de Windows", "Adicionar 'Abrir no Lumi Files' ao menu de contexto do Windows"),
            ...
            ("Settings_BuyMeCoffeeDesc", "If you enjoy Lumi Files, support with a coffee!", "Lumi Files이 마음에 드셨다면, 커피 한 잔으로 응원해 주세요!", "Lumi Filesを気に入っていただけたら、コーヒー1杯で応援してください！", "如果您喜欢 Lumi Files，请请我喝杯咖啡！", "如果您喜歡 Lumi Files，請請我喝杯咖啡！", "Wenn Ihnen Lumi Files gefällt, unterstützen Sie uns mit einem Kaffee!", "Si disfrutas de Lumi Files, ¡apoya con un café!", "Si vous aimez Lumi Files, offrez un café en soutien !", "Se você gosta do Lumi Files, apoie com um café!"),
            ...
            ("Tray_Show", "Show LumiFiles", "LumiFiles 열기", "LumiFilesを表示", "显示 LumiFiles", "顯示 LumiFiles", "LumiFiles anzeigen", "Mostrar LumiFiles", "Afficher LumiFiles", "Mostrar LumiFiles"),
            ("Tray_Exit", "Exit LumiFiles", "LumiFiles 종료", "LumiFilesを終了", "退出 LumiFiles", "結束 LumiFiles", "LumiFiles beenden", "Salir de LumiFiles", "Quitter LumiFiles", "Sair do LumiFiles"),
