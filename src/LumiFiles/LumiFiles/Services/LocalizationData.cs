namespace LumiFiles.Services
{
    public partial class LocalizationService
    {
        internal static readonly (string key, string en, string ko, string ja, string zhHans, string zhHant, string de, string es, string fr, string ptBR)[] Entries =
        {
            ...
            ("Settings_SupportThanksMsg", "Your support means a lot to the development of LumiFinder!", "후원해 주셔서 정말 감사합니다! 큰 힘이 됩니다!", "ご支援ありがとうございます！大きな励みになります！", "您的支持对LumiFinder的开发意义重大！", "您的支持對LumiFinder的開發意義重大！", "Ihre Unterstutzung bedeutet viel fur die Entwicklung von LumiFinder!", "Su apoyo significa mucho para el desarrollo de LumiFinder!", "Votre soutien compte beaucoup pour le developpement de LumiFinder !", "Seu apoio significa muito para o desenvolvimento do LumiFinder!"),
            ...
            ("Tray_Show", "Show LumiFinder", "LumiFinder 열기", "Spanを表示", "显示 LumiFinder", "顯示 LumiFinder", "LumiFinder anzeigen", "Mostrar LumiFinder", "Afficher LumiFinder", "Mostrar LumiFinder"),
            ("Tray_Exit", "Exit LumiFinder", "LumiFinder 종료", "Spanを終了", "退出 LumiFinder", "結束 LumiFinder", "LumiFinder beenden", "Salir de LumiFinder", "Quitter LumiFinder", "Sair do LumiFinder"),
