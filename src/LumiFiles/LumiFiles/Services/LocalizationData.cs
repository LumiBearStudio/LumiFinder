namespace LumiFiles.Services
{
    public partial class LocalizationService
    {
        internal static readonly (string key, string en, string ko, string ja, string zhHans, string zhHant, string de, string es, string fr, string ptBR)[] Entries =
        {
            ...
            ("Settings_ContextMenuDesc", "Add 'Open in LumiFiles' to Windows right-click menu", "윈도우 우클릭 메뉴에 'Open in LumiFiles' 추가", "Windowsの右クリックメニューに「Open in LumiFiles」を追加", "将\u201C在 LumiFiles 中打开\u201D添加到 Windows 右键菜单", "將「在 LumiFiles 中開啟」新增到 Windows 右鍵功能表", "'In LumiFiles öffnen' zum Windows-Kontextmenü hinzufügen", "Agregar 'Abrir en LumiFiles' al menú contextual de Windows", "Ajouter « Ouvrir dans LumiFiles » au menu contextuel de Windows", "Adicionar 'Abrir no LumiFiles' ao menu de contexto do Windows"),
            ...
            ("Settings_BuyMeCoffeeDesc", "If you enjoy LumiFiles, support with a coffee!", "LumiFiles가 마음에 드셨다면, 커피 한 잔으로 응원해 주세요!", "LumiFilesを気に入っていただけたら、コーヒー1杯で応援してください！", "如果您喜欢 LumiFiles，请请我喝杯咖啡！", "如果您喜歡 LumiFiles，請請我喝杯咖啡！", "Wenn Ihnen LumiFiles gefällt, unterstützen Sie uns mit einem Kaffee!", "Si disfrutas de LumiFiles, ¡apoya con un café!", "Si vous aimez LumiFiles, offrez un café en soutien !", "Se você gosta do LumiFiles, apoie com um café!"),
            ...
            ("Settings_DefaultFMDesc", "Use Lumi Files to open folders/drives", "폴더/드라이브를 열 때 Lumi Files 사용", "フォルダー/ドライブを開く際にLumi Filesを使用", "使用 Lumi Files 打开文件夹/驱动器", "使用 Lumi Files 開啟資料夾/磁碟機", "Lumi Files zum Öffnen von Ordnern/Laufwerken verwenden", "Usar Lumi Files para abrir carpetas/unidades", "Utiliser Lumi Files pour ouvrir les dossiers/lecteurs", "Usar o Lumi Files para abrir pastas/unidades"),
            ...
            ("Settings_SupportDesc", "Lumi Files is a free open-source project. Your support means a lot!", "Lumi Files는 무료 오픈소스 프로젝트입니다. 개발을 응원해 주시면 큰 힘이 됩니다!", "Lumi Filesは無料のオープンソースプロジェクトです。ご支援いただけると大きな力になります！", "Lumi Files 是一个免费开源项目。您的支持对我们意义重大！", "Lumi Files 是一個免費開源專案。您的支持對我們意義重大！", "Lumi Files ist ein kostenloses Open-Source-Projekt. Ihre Unterstützung bedeutet uns viel!", "Lumi Files es un proyecto de código abierto gratuito. ¡Tu apoyo significa mucho!", "Lumi Files est un projet open source gratuit. Votre soutien compte beaucoup !", "Lumi Files é um projeto de código aberto gratuito. Seu apoio significa muito!"),
            ...
            ("Settings_SupportThanksMsg", "Your support means a lot to the development of Lumi Files!", "후원해 주셔서 정말 감사합니다! 큰 힘이 됩니다!", "ご支援ありがとうございます！大きな励みになります！", "您的支持对Lumi Files的开发意义重大！", "您的支持對Lumi Files的開發意義重大！", "Ihre Unterstutzung bedeutet viel fur die Entwicklung von Lumi Files!", "Su apoyo significa mucho para el desarrollo de Lumi Files!", "Votre soutien compte beaucoup pour le developpement de Lumi Files !", "Seu apoio significa muito para o desenvolvimento do Lumi Files!"),
            ...
            ("Settings_DefaultFMInfo2", "• UAC approval is also required to unregister. Please disable this setting BEFORE uninstalling Lumi Files.", "• 해제 시에도 UAC 승인이 필요합니다. Lumi Files를 제거하기 전에 반드시 이 설정을 먼저 해제하세요.", "• 登録解除にもUAC承認が必要です。Lumi Filesをアンインストールする前に必ずこの設定を解除してください。", "• 取消注册也需要 UAC 批准。卸载 Lumi Files 之前请务必先关闭此设置。", "• 取消註冊也需要 UAC 核准。解除安裝 Lumi Files 之前請務必先關閉此設定。", "• Auch zum Aufheben der Registrierung ist eine UAC-Genehmigung erforderlich. Deaktivieren Sie diese Einstellung VOR der Deinstallation.", "• También se requiere aprobación UAC para cancelar el registro. Desactive esta configuración ANTES de desinstalar.", "• L'approbation UAC est également requise pour la désinscription. Désactivez ce paramètre AVANT de désinstaller.", "• A aprovação UAC também é necessária para cancelar o registro. Desative esta configuração ANTES de desinstalar."),
            ...
            ("Tray_Show", "Show LumiFiles", "LumiFiles 열기", "Spanを表示", "显示 LumiFiles", "顯示 LumiFiles", "LumiFiles anzeigen", "Mostrar LumiFiles", "Afficher LumiFiles", "Mostrar LumiFiles"),
            ("Tray_Exit", "Exit LumiFiles", "LumiFiles 종료", "Spanを終了", "退出 LumiFiles", "結束 LumiFiles", "LumiFiles beenden", "Salir de LumiFiles", "Quitter LumiFiles", "Sair do LumiFiles"),
