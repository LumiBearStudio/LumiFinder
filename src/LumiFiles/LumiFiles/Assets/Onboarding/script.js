/* ══════════════════════════════════════════════
   LumiFinder Onboarding — client script
   ══════════════════════════════════════════════ */
...
(function () {
  ...
  const I18N = {
    en: {
      ...
      shelf_title: 'Split View',
      shelf_desc: 'Open two folders side-by-side in a single window. Drag files between panes to copy or move.',
      sv_src: 'Source',
      sv_dst: 'Destination',
      shelf_label: 'Shelf',
      ...
      dfm_title: 'Set LumiFinder as my default file explorer',
      dfm_desc: 'Replace the built-in Windows Explorer with LumiFinder. Requires admin (UAC) approval.',
    ...
    ko: {
      ...
      shelf_title: '\ubd84\ud560 \ubdf0',
      shelf_desc: '\ud55c \ucc3d \uc548\uc5d0 \ub450 \ud3f4\ub354\ub97c \ub098\ub780\ud788 \uc5f4\uace0,\n\ud30c\uc77c\uc744 \ub04c\uc5b4 \ub2e4\ub978 \ud3f4\ub354\ub85c \ubcf5\uc0ac/\uc774\ub3d9\ud558\uc138\uc694.',
      sv_src: '\uc6d0\ubcf8',
      sv_dst: '\ub300\uc0c1',
      shelf_label: 'Shelf',
      theme_title: '테마 선택',
      ...
      dfm_title: 'LumiFinder를 기본 파일 탐색기로 사용',
      dfm_desc: 'Windows 기본 탐색기를 LumiFinder로 대체합니다. 관리자 승인(UAC)이 필요해요.',
    ...
    ja: {
      ...
      dfm_title: 'LumiFinderを既定のファイルエクスプローラーに設定',
      dfm_desc: 'Windowsの既定エクスプローラーをLumiFinderに置き換えます。管理者権限（UAC）が必要です。',
    ...
    'zh-Hans': {
      ...
      mc_projects: '项目', mc_span: 'LumiFinder', mc_notes: '笔记',
      mc_readme: 'README.md', mc_main: 'MainWindow.xaml', mc_app: 'App.xaml', mc_assets: 'Assets',
      tabs_title: '标签页与分离',
      tabs_desc: '在标签页中打开多个文件夹，\n将标签页拖出可分离为新窗口。',
      shelf_title: '分割视图',
      shelf_desc: '在同一窗口内并排打开两个文件夹,\n拖动文件即可复制或移动。',
      ...
      dfm_title: '将 LumiFinder 设为默认文件资源管理器',
      dfm_desc: '用 LumiFinder 替换 Windows 内置资源管理器。需要管理员权限（UAC）。',
    ...
    'zh-Hant': {
      ...
      mc_projects: '專案', mc_span: 'LumiFinder', mc_notes: '筆記',
      mc_readme: 'README.md', mc_main: 'MainWindow.xaml', mc_app: 'App.xaml', mc_assets: 'Assets',
      tabs_title: '分頁與分離',
      tabs_desc: '在分頁中開啟多個資料夾，\n將分頁拖出可分離為新視窗。',
      shelf_title: '分割檢視',
      shelf_desc: '在同一視窗內並排開啟兩個資料夾,\n拖曳檔案即可複製或移動。',
      ...
      dfm_title: '將 LumiFinder 設為預設檔案總管',
      dfm_desc: '以 LumiFinder 取代 Windows 內建檔案總管。需要系統管理員權限（UAC）。',
    ...
    de: {
      ...
      mc_projects: 'Projekte', mc_span: 'LumiFinder', mc_notes: 'Notizen',
      mc_readme: 'README.md', mc_main: 'MainWindow.xaml', mc_app: 'App.xaml', mc_assets: 'Assets',
      tabs_title: 'Tabs & Abreißen',
      tabs_desc: 'Öffne mehrere Ordner in Tabs.\nZiehe einen Tab heraus, um ihn als eigenes Fenster zu lösen.',
      shelf_title: 'Geteilte Ansicht',
      shelf_desc: 'Öffne zwei Ordner nebeneinander in einem Fenster\nund ziehe Dateien zum Kopieren oder Verschieben.',
      ...
      dfm_title: 'LumiFinder als Standard-Datei-Explorer festlegen',
      dfm_desc: 'Ersetzt den Windows-Explorer durch LumiFinder. Erfordert Administratorrechte (UAC).',
    ...
    es: {
      ...
      mc_projects: 'Proyectos', mc_span: 'LumiFinder', mc_notes: 'Notas',
      mc_readme: 'README.md', mc_main: 'MainWindow.xaml', mc_app: 'App.xaml', mc_assets: 'Assets',
      ...
      shelf_title: 'Vista dividida',
      shelf_desc: 'Abre dos carpetas lado a lado en una sola ventana\ny arrastra archivos para copiarlos o moverlos.',
      ...
      dfm_title: 'Establecer LumiFinder como explorador de archivos predeterminado',
      dfm_desc: 'Sustituye el Explorador de Windows por LumiFinder. Requiere aprobación de administrador (UAC).',
    ...
    fr: {
      ...
      mc_projects: 'Projets', mc_span: 'LumiFinder', mc_notes: 'Notes',
      mc_readme: 'README.md', mc_main: 'MainWindow.xaml', mc_app: 'App.xaml', mc_assets: 'Assets',
      ...
      shelf_title: 'Vue partagée',
      shelf_desc: 'Ouvrez deux dossiers côte à côte dans une seule fenêtre\net glissez les fichiers pour les copier ou déplacer.',
      ...
      dfm_title: 'Définir LumiFinder comme explorateur de fichiers par défaut',
      dfm_desc: 'Remplace l\u2019Explorateur Windows par LumiFinder. Nécessite l\u2019approbation administrateur (UAC).',
    ...
    'pt-BR': {
      ...
      mc_projects: 'Projetos', mc_span: 'LumiFinder', mc_notes: 'Notas',
      mc_readme: 'README.md', mc_main: 'MainWindow.xaml', mc_app: 'App.xaml', mc_assets: 'Assets',
      ...
      shelf_title: 'Visualização dividida',
      shelf_desc: 'Abra duas pastas lado a lado em uma única janela\ne arraste arquivos para copiar ou mover.',
      ...
      dfm_title: 'Definir LumiFinder como gerenciador de arquivos padrão',
      dfm_desc: 'Substitui o Explorador do Windows pelo LumiFinder. Requer aprovação de administrador (UAC).',
